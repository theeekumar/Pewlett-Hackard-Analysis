...
SELECT e.emp_no, ri.first_name, ri.last_name, de.dept_no, d.dept_name 
INTO sales_dept 
FROM employees AS e
INNER JOIN retirement_info as ri
ON (e.first_name = ri.first_name AND e.last_name = ri.last_name)
INNER JOIN dept_emp as de
ON (e.emp_no = de.emp_no)
INNER JOIN departments as d
ON (de.dept_no = d.dept_no) WHERE d.dept_name = 'Sales';
SELECT emp_no, first_name, last_name, dept_name FROM sales_dept;
